...
// import { deleteUser, getAllUsers, allUsers, changeRole, sendEmail } from "../service/admin";
...
//   // Email submission processing workflow pipeline
...
//             <div className="hidden md:grid grid-cols-[74px_2fr_2fr_2fr_130px] items-center gap-4 px-6 py-3 border-b-4 border-black bg-yellow-300 font-black uppercase tracking-wider text-sm">
...
//                   <div
//                     key={user._id || idx}
//                     className="flex flex-col md:grid md:grid-cols-[74px_2fr_2fr_2fr_130px] items-start md:items-center gap-4 px-6 py-4 hover:bg-purple-50 transition-colors bg-white cursor-pointer group"
...
//                     {/* Column 5: Action Processing Group Box */}
//                     <div
