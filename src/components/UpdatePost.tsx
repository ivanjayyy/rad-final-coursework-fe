...
//   // Geocode the existing location string so the map pin lands correctly
//   useEffect(() => {
...
//         {imagePreview && (
//           <div className="mb-3 flex items-center gap-3 p-3 bg-gray-50 border border-gray-200 rounded-md">
//             <img
//               src={imagePreview}
//               alt="Current"
...
//         <label className="flex flex-col items-center justify-center w-full h-24 border-2 border-dashed border-gray-300 rounded-md cursor-pointer hover:border-blue-400 hover:bg-blue-50 transition">
//           <svg
...
//         className="w-full py-3 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 disabled:opacity-60 disabled:cursor-not-allowed text-white text-sm font-semibold rounded-md transition-colors flex items-center justify-center gap-2"
//       >
//         {isSubmitting && (
//           <svg
